...
public class WebSession implements Serializable {
    ...
    /**
     * Toggles the securityEnabled flag only if the current user has the 'ROLE_ADMIN' authority.
     * This prevents unauthorized users from changing the security state.
     */
    public void toggleSecurity() {
        ...
        throw new SecurityException("Access denied: insufficient privileges to toggle security state.");
    }
